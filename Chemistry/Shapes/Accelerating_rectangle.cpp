...
Accelerating_rectangle::Accelerating_rectangle(const Radius_vector &par_acceleration, 
	                                           ...
	                                           const bool par_active, const bool par_just_born) : Rectangle(par_width, par_height, par_type, par_centre_position, par_velocity, par_weight, par_color, par_active, par_just_born)
{
