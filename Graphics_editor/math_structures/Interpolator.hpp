...
public:
	...
	Vector_d get_point(double x, size_t *last_ref_point)
	{
		...
		if (*last_ref_point == 0)
		{
			Vector_d point_0 = Vector_d(reference_points[0].get_x() - DELTA, reference_points[0].get_y());
			...
			{
				point_3 = Vector_d(reference_points[1].get_x(), reference_points[1].get_y() + DELTA);
			}
			else
