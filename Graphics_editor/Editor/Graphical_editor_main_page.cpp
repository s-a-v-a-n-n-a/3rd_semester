...
: Visual_object(par_type, par_position, par_color, par_width, par_height), pencil()
{
	...
	Full_texture *background = new Full_texture(WINDOW_BACKGROUND);
	...
	Tools_vidget *tools_vidget = new Tools_vidget((size_t)Vidget_type::PALETTE, par_position + Vector_ll(DEFAULT_COLOR_VIDGET_POS_X, DEFAULT_COLOR_VIDGET_POS_Y), background, DEFAULT_COLOR_VIDGET_WIDTH, DEFAULT_COLOR_VIDGET_HEIGHT, &pencil);
	Brush_size_manager *brushes_vidget = new Brush_size_manager((size_t)Vidget_type::PALETTE, par_position + Vector_ll(DEFAULT_SIZE_VIDGET_POS_X, DEFAULT_SIZE_VIDGET_POS_Y), background, THICK_PALETTE_WIDTH, THICK_PALETTE_HEIGHT, &pencil);
    ...
    Button *canvas_restore_button = panel->add_button(canvas_restore, CANVAS_TEXT, WHITE, current_button_size + DEFAULT_TEXT_OFFSET * 2, INCREASED_BUTTON_HEIGHT);
	...
	Button *canvas_controller = panel->add_button(canvas_creator, NEW_CANVAS_TEXT, WHITE, current_button_size + DEFAULT_TEXT_OFFSET * 2, INCREASED_BUTTON_HEIGHT);
    ...
    Button *tools_restore_button = panel->add_button(tools_restore, COLOR_TEXT, WHITE, current_button_size + DEFAULT_TEXT_OFFSET * 2, INCREASED_BUTTON_HEIGHT);
    ...
    Button *brushes_restore_button = panel->add_button(brushes_restore, SIZE_TEXT, WHITE, current_button_size + DEFAULT_TEXT_OFFSET * 2, INCREASED_BUTTON_HEIGHT);
    brushes_restore->set_interactive(brushes_restore_button);

    // test
    Full_texture *test_texture = new Full_texture(TEST_WINDOW);
...
: Visual_object(par_type, par_position, texture, par_width, par_height), pencil()
{
	...
	Full_texture *tools_texture = new Full_texture(TOOLS_BACKGROUND_TEXTURE);
	Full_texture *brushes_texture = new Full_texture(BRUSHES_BACKGROUND_TEXTURE);
	Tools_vidget *tools_vidget = new Tools_vidget((size_t)Vidget_type::PALETTE, par_position + Vector_ll(DEFAULT_COLOR_VIDGET_POS_X, DEFAULT_COLOR_VIDGET_POS_Y), tools_texture, 0, 0, &pencil);
	Brush_size_manager *brushes_vidget = new Brush_size_manager((size_t)Vidget_type::PALETTE, par_position + Vector_ll(DEFAULT_SIZE_VIDGET_POS_X, DEFAULT_SIZE_VIDGET_POS_Y), brushes_texture, 0, 0, &pencil);
