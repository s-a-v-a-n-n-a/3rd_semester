...
Drop_down_menu_manager::Drop_down_menu_manager(const size_t par_type, const Radius_vector &par_position, const Color &par_color, const size_t par_width, const size_t par_height, Visual_object *to_control)
: Visual_object(par_type, par_position, par_color, par_width, par_height)
{
	...
	Drop_down_menu *subordinate = new Drop_down_menu(Vidget_type::DROP_DOWN_MENU, par_position + Radius_vector(0.0, 80.0), par_color, par_width, par_height, to_control);
...
Drop_down_menu::Drop_down_menu(const size_t par_type, const Radius_vector &par_position, const Color &par_color, const size_t par_width, const size_t par_height, Button_delegate *par_delegate)
: Visual_object(par_type, par_position, par_color, par_width, par_height)
{
